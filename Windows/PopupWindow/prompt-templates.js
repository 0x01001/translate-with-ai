const REWRITE_PROMPT_TEMPLATE = [
    ...
    "{{selectedText}}",
    "\"\"\"",
    "IMPORTANT: You MUST preserve the original language of the input text. The rewrite MUST be in that same language. Never translate or switch to another language unless explicitly requested.",
...
const WRITE_PROMPT_TEMPLATE = [
    ...
    "- Length: {{length}}",
    "{{contextLine}}",
    "IMPORTANT: You MUST match the language of the user's topic/prompt and context text. Write the output in that same language. Never switch to another language unless explicitly requested.",
